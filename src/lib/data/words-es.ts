...

{
  ...
  image_url: '',
  has_image: false,
  definition: 'Que siente enojo, furia o irritación ante algo.',
  features: {
    category: 'emotions',
    function: 'Expresa rechazo o molestia ante una situación injusta.',
...

{
  ...
  opposite: 'tranquilo',
  synonyms: ['inquieto', 'nervioso', 'apezorado'],
},

{
  ...
  synonyms: ['añorante', 'melancólico', 'recuerdista'],
},
...

{
  ...
  opposite: 'ilusionado',
  synonyms: ['desilusionado', 'desencantado', 'chacoteado'],
},
...

{
  ...
  image_url: '',
  has_image: false,
  definition: 'Que siente enojo y rechazo ante una injusticia.',
  features: {
    category: 'emotions',
...

{
  ...
  opposite: 'paciente',
  synonyms: ['molesto', 'fastidiado', 'enojado'],
},
...

{
    ...
    image_url: '',
    has_image: false,
    definition: 'Esposo de la hija o del hijo',
    features: {
      category: 'family',
...

{
    ...
    image_url: '',
    has_image: false,
    definition: 'Esposa del hijo o de la hija',
    features: {
      category: 'family',
...

{
    ...
    image_url: '',
    has_image: false,
    definition: 'Nuevo esposo del padre o de la madre',
    features: {
      category: 'family',
...

{
    ...
    image_url: '',
    has_image: false,
    definition: 'Nueva esposa del padre o de la madre',
    features: {
      category: 'family',
      function: 'Es la nueva pareja de uno de los padres',
      location: 'En el ámbito familiar',
...

{
    ...
    phonetic: { first_sound: '/Ø/', syllables: 3, rhyming_word: 'rastro', first_phonemes: '/Øi/' },
    difficulty: 3,
    tags: ["familia", "parientes", "familia reconstituida"],
...

{
    ...
    phonetic: { first_sound: '/Ø/', syllables: 3, rhyming_word: 'maestra', first_phonemes: '/Øi/' },
    difficulty: 3,
    tags: ["familia", "parientes", "familia reconstituida"],
...

{
    ...
    phonetic: { first_sound: '/k/', syllables: 3, rhyming_word: 'szedena', first_phonemes: '/ka/' },
    difficulty: 2,
...

{
    ...
    phonetic: { first_sound: '/s/', syllables: 2, rhyming_word: 'grafía', first_phonemes: '/se/' },
    difficulty: 2,
...

{
    ...
    phonetic: { first_sound: '/a/', syllables: 4, rhyming_word: 'mosquición', first_phonemes: '/a/' },
    difficulty: 3,
...

{
    ...
    phonetic: { first_sound: '/Ø/', syllables: 2, rhyming_word: 'pastel', first_phonemes: '/Øo/' },
    difficulty: 1,
...

{
    ...
    opposite: 'tacones',
    synonyms: ["tenis", "deportivas", "zapatillas de deporte"],
  },
...

{
    ...
    opposite: '',
    synonyms: ["cuatrimoto", "veh\u00edculo todo terreno"],
  },

{
    ...
    phonetic: { first_sound: '/m/', syllables: 5, rhyming_word: 'totuga', first_phonemes: '/mo/' },
    difficulty: 2,
...

{
    ...
    phonetic: { first_sound: '/k/', syllables: 4, rhyming_word: 'willamáng', first_phonemes: '/ka/' },
    difficulty: 3,
...

{
    ...
    features: {
      ...
      properties: 'Grande, amarillo, con paradas fijas, asientos',
...

{
    ...
    phonetic: { first_sound: '/aɾ/', syllables: 2, rhyming_word: 'escarpa', first_phonemes: '/aɾ/' },
    difficulty: 1,
    tags: ['instrumento'],
...

{
    ...
    features: { category: 'sports', function: 'se jueva golpeando un disco o pelota con un stick curvo', location: 'en una pista de hielo o sobre césped', properties: 'deporte de equipo que usa un palo largo con extremo curvado', associations: 'stick, disco, hielo, patines, equipo' },
...

{
    ...
    phonetic: { first_sound: '/ɡ/', syllables: 2, rhyming_word: 'marroquí', first_phonemes: '/ɡ/' },
    difficulty: 1,
...

{
    ...
    opposite: '',
    synonyms: ['control remoto', 'mando a distancia'],
  },
...

{
    ...
    image_url: '',
    has_image: false,
    definition: 'Objeto de metal en forma de copa que suena al golpearlo.',
...

{
    ...
    features: { category: 'music', function: 'Producir melodías pulsando cuerdas.', location: 'En museos y actuaciones clásicas.', properties: 'Pequeña, con cuerdas tensadas en un marco.', asociations: 'arpa, antiguo, Grecia, cuerda, mitología' },
...

{
    ...
    features: { category: 'places', function: 'Dar descanso y recuerdo a los fallecidos.', location: 'En las afueras de los pueblos.', properties: 'Terreno con tumbas, lápidas y nichos.', asociations: 'tumba, lápida, flor, silencio, recuerdo' },
    phonetic: { first_sound: '/s/', syllables: 5, rhyming_word: 'riterio', first_phonemes: '/se/' },
    difficulty: 2,
    tags: ['espacio'],
...

{
    ...
    features: { category: 'places', function: 'Honrar y recordar un hecho histórico.', location: 'En plazas y lugares públicos.', properties: 'Estructura de piedra o metal con inscripciones.', asociations: 'historia, estatua, plaza, recuerdo, homenaje' },
...

{
    ...
    features: { category: 'school', function: 'Escribir en la pizarra.', location: 'En la mesa del profesor.', properties: 'Barra blanca o de colores, polvorienta.', asociations: 'pizarra, profesor, escribir, blanco, polvo' },
...

{
    ...
    features: { category: 'school', function: 'Escribir o colorear con colores vivos.', location: 'En el estuche del alumno.', properties: 'Tubo de plástico con punta de fieltro.', asociations: 'marcador, color, pintar, escribir, punta' },
...

{
    ...
    features: { category: 'school', function: 'Pegar papeles y materiales.', location: 'En el estuche y la mochila.', properties: 'Líquido blanco o barra, pegajoso.', asociations: 'cola, papel, manualidad, pegar, unir' },
...

{
    ...
    features: { category: 'school', function: 'Pintar dibujos con colores.', location: 'En el estuche del alumno.', properties: 'Caja con muchos lápices de colores.', asociations: 'lápiz, pintar, dibujar, rojo, azul' },
...

{
    ...
    features: { category: 'school', function: 'Modelar figuras con las manos.', location: 'En el aula de arte.', properties: 'Masa suave, flexible, de colores vivos.', asociations: 'modelar, figura, mano, suave, color' },
...

{
    ...
    features: { category: 'school', function: 'Escribir, dibujar o imprimir.', location: 'En cuadernos y paquetes.', properties: 'Fina, blanca, flexible.', asociations: 'hoja, escribir, blanco, cuaderno, imprimir' },
...

{
    ...
    features: { category: 'school', function: 'Aprender a contar y calcular.', location: 'En el aula de matemáticas.', properties: 'Marco de madera con varillas y bolas coloridas.', asociations: 'contar, bolas, matemáticas, número, calcular' },
...

{
    ...
    features: { category: 'school', function: 'Ampliar objetos diminutos para verlos.', location: 'En el laboratorio del colegio.', properties: 'Tubo con lentes y plataforma.', asociations: 'ciencia, lente, pequeño, ver, laboratorio' },
...

{
    ...
    features: { category: 'school', function: 'Observar estrellas y planetas.', location: 'En observatorios y clases de ciencias.', properties: 'Tubo largo con lentes y soporte.', asociations: 'estrella, planeta, espacio, lente, observar' },
...

{
    ...
    features: { category: 'school', function: 'Representar un país o institución.', location: 'En el patio del colegio.', properties: 'Tela rectangular con colores y símbolos.', asociations: 'país, colores, patriotismo, mástil, ondear' },
...

{
    ...
    features: { category: 'school', function: 'Descansar y jugar entre clases.', location: 'En el patio del colegio.', properties: 'Periodo de tiempo libre.', asociations: 'descanso, patio, jugar, descanso, pausa' },
...

{
    ...
    features: { category: 'school', function: 'Evaluar lo que el alumno ha aprendido.', location: 'En el aula.', properties: 'Hoja con preguntas para responder.', asociations: 'prueba, nota, pregunta, estudiar, calificación' },
...

{
    ...
    features: { category: 'school', function: 'Aprender un tema nuevo.', location: 'En el libro de texto.', properties: 'Un tema o capítulo del libro.', asociations: 'tema, libro, aprender, estudiar, capítulo' },
...

{
    ...
    features: { category: 'school', function: 'Espacio donde se enseña y aprende.', location: 'En el edificio del colegio.', properties: 'Habitación con pupitres y una pizarra.', asociations: 'clase, pizarra, pupitre, alumno, profesor' },
...

{
    ...
    features: { category: 'school', function: 'Conectar las diferentes aulas.', location: 'En el interior del edificio.', properties: 'Corredor largo y estrecho.', asociations: 'corredor, puerta, aula, caminar, edificio' },
...

{
    ...
    features: { category: 'school', function: 'Comer durante el horario escolar.', location: 'En el colegio.', properties: 'Sala grande con mesas y sillas.', asociations: 'comida, almuerzo, mesa, menú, comida' },
...

{
    ...
    features: { category: 'school', function: 'Consultar mapas y datos de países.', location: 'En la biblioteca del colegio.', properties: 'Libro grande con mapas a color.', asociations: 'mapa, geografía, país, mundo, continente' },
...

{
    ...
    features: { category: 'school', function: 'Llevar libros y materiales al colegio.', location: 'En la espalda del alumno.', properties: 'Bolsa con tirantes, compartimentos.', asociations: 'libro, escuela, espalda, transportar, cuaderno' },
...

{
    ...
    features: { category: 'school', function: 'Escribir para que toda la clase vea.', location: 'En la pared delantera del aula.', properties: 'Superficie plana, verde o blanca.', asociations: 'tiza, profesor, escribir, clase, borrar' },
